                    ...
                    <div class="list-checkbox pb-20">
                        <div class="row position-relative mt-10 mb-20">
                            ...
                            <div class="box-input-money">
                                ...
                                <input class="input-disabled form-control submit-form-filter" name="offered_salary_to" type="hidden" value="{{ BaseHelper::stringify(request()->query('offered_salary_to', $maxSalaryRange)) }}">
                            </div>
                        </div>
                    </div>
                </div>
